...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "SMK Bani Rosa Insani",
      logo: require("./assets/images/harvardLogo.png"),
      subHeader: "SMU/SMK/STM in Ilmu Komputer/Teknologi Informasi | Indonesia",
      duration: "Feb 2017 - Mei 2020",
      desc: "Jurusan RPL Rekayasa Perangkat Lunak.",
      descBullets: [
        "Sistem Komputer, Jaringan Komputer, Algoritma dan Pemrograman",
        "Desain Grafis, Basis Data, Membuat Aplikasi Web dan Mobile",
